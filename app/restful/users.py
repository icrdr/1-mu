...
M_PROJECT_LOG = api.model('project_log', {
    'id': fields.Integer(),
    'operator': fields.Nested(M_MIN_USER),
    'log_type': fields.String(),
    'log_date': fields.String(),
    'project': fields.Nested(M_MIN_PROJECT),
    'phase': fields.Nested(M_MIN_PHASE),
    'content': fields.String(),
})

M_PROJECT_NOTICE = api.model('project_log', {
    'id': fields.Integer(),
    'log': fields.Nested(M_PROJECT_LOG),
    'read': fields.Boolean
})

M_PROJECT_NOTICES = api.model('project_logs', {
    'project_notices': fields.List(fields.Nested(M_PROJECT_NOTICE)),
    'total': fields.Integer,
    'unread': fields.Integer,
})

G_PROJECT_NOTICES = reqparse.RequestParser()\
